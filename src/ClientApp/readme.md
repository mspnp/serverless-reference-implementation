...
az pipelines variable create --organization $AZURE_DEVOPS_ORG --project $AZURE_DEVOPS_PROJECT_NAME --pipeline-name=clientapp-cicd --name=releaseVersion --value=v1 && \
az pipelines variable create --organization $AZURE_DEVOPS_ORG --project $AZURE_DEVOPS_PROJECT_NAME --pipeline-name=clientapp-cicd --name=releaseSemVer --value=v1
# kick off first run
